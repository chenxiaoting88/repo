...
public class SuperMarket {
	...
	public static void main(String[] args) throws Exception {
		...
		if(sm.getCalTotalPrice("A", 3)==3*(8+13))
			System.out.println("顾客A购买3斤苹果和草莓梨的总价计算正确3*(8+13)="+3*(8+13));
		if( sm.getCalTotalPrice("B", 4)==4*(8+13+20))
			System.out.println("顾客B购买4斤苹果、草莓和芒果的总价计算正确4*(8+13+20)="+4*(8+13+20));
		if(sm.getCalTotalPrice("C", 5)==5*(8L+13*0.8+20l))
			System.out.println("顾客C购买5斤苹果、草莓和芒果草莓八折的总价计算正确5*(8+13*0.8+20)="+5*(8+13*0.8+20));
